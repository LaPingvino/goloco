...
// Vehicle represents a game vehicle
// TODO: This is a minimal structure, needs expansion
type Vehicle struct {
...
// VehicleHead represents the head entity of a vehicle
type VehicleHead struct {
	Vehicle
	// TODO: Add head-specific fields
}

// VehicleTail represents the tail entity of a vehicle
type VehicleTail struct {
	Vehicle
	// TODO: Add tail-specific fields
}

// VehicleBogie represents a bogie (wheel assembly) entity
type VehicleBogie struct {
	Vehicle
	// TODO: Add bogie-specific fields
}

// VehicleBody represents a vehicle body entity
type VehicleBody struct {
	Vehicle
	// TODO: Add body-specific fields
}
