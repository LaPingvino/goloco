...
var VehicleDetailsOffset = 2 // auto
var VehicleDetailsLineHeight = 12 // auto
var VehicleDetailsTextHeight2Lines = kVehicleDetailsOffset + kVehicleDetailsLineHeight * 2 // auto
var VehicleDetailsTextHeight3Lines = kVehicleDetailsOffset + kVehicleDetailsLineHeight * 3 // auto
...
// tr.drawStringLeftClipped(pos, std::min<uint16_t>(self.width - 16, textRightEdge), Colour::black, str, args);
// // 0x004B36A3
// func DrawScroll(self Window, drawingCtx Gfx::DrawingContext, i [[maybe_unused]] uint32_t) 
// auto tr = Gfx::TextRenderer(drawingCtx);
