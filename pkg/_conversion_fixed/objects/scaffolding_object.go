...
type ScaffoldingObject struct {
	Name StringId
	Image uint32
// uint16 segmentHeights[3]; // 0x06
// uint16 roofHeights[3];    // 0x0C
...
func (s *ScaffoldingObject) Validate() bool {
	// void load(const LoadedObjectHandle& handle, []<const std::byte> data, ObjectManager::DependentObjects*);
	// void unload();
}
...
func init() {
ScaffoldingImages = [3]ScaffoldingImages{
...
// },
// },
// constexpr const ScaffoldingImages& getScaffoldingImages(uint8 type) { return kScaffoldingImages[type]; }
