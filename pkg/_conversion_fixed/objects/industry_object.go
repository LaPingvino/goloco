...
type IndustryObject struct {
	...
	// uint32 animationSequenceOffsets[4];      // 0x28 Access with getAnimationSequence helper method
	Var_38_Offset uint32
	// uint32 buildingVariationPartOffsets[32]; // 0x3C Access with getBuildingParts helper method
	...
	// uint8 producedCargoType[2];                               // 0xDE (0xFF = null)
	// uint8 requiredCargoType[3];                               // 0xE0 (0xFF = null)
	MapColour                       Colour
	...
	// uint8 wallTypes[4];                    // 0xED There can be up to 4 different wall types for an industry
	...
	// method: void drawIndustry(Gfx::DrawingContext& drawingCtx, int16 x, int16 y) const;
	...
	// []<const std::uint8> getAnimationSequence(const uint8 unk) const;
	// []<const std::uint8> getBuildingPartHeights() const;
	// []<const IndustryObjectUnk38> getUnk38() const;
	// []<const BuildingPartAnimation> getBuildingPartAnimations() const;
	// []<const std::uint8> getBuildings() const;
