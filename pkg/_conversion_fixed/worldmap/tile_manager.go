...
// TileElement* insertElement(ElementType type, const Pos2& pos, uint8 baseZ, uint8 occupiedQuads);
// // Note: Any TileElement pointers invalid after this call
// template<typename TileT>
// TileT* insertElement(const Pos2& pos, const uint8 baseZ, const uint8 occupiedQuads)
// func InsertElement(TileT::kElementType, pos, baseZ, occupiedQuads) return
// // Note: `after` pointer will be invalid after this call
// TileElement* insertElementAfterNoReorg(TileElement* after, ElementType type, const Pos2& pos, uint8 baseZ, uint8 occupiedQuads);
// // Note: `after` pointer will be invalid after this call
// template<typename TileT>
// TileT* insertElementAfterNoReorg(TileElement* after, const Pos2& pos, const uint8 baseZ, const uint8 occupiedQuads)
// func InsertElementAfterNoReorg(after, TileT::kElementType, pos, baseZ, occupiedQuads) return
// // Special road element insert
// World::RoadElement* insertElementRoad(const Pos2& pos, uint8 baseZ, uint8 occupiedQuads);
