...
// window->rowCount = static_cast<uint16>(_loadErrorObjectsList.size());
// window->rowHover = -1;
// orphan member: return window;
...
// func ObjectTypeToString(type ObjectType) StringId
// switch (type)
...
// for (uint16 i = 0; i < window.rowCount; i++)
...
// uint16 currentTrack = y / kRowHeight;
