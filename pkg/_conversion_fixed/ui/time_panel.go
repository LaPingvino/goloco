...
// static constexpr uint32 map_sprites_by_rotation[] = {
...
// args.push<uint32>(getCurrentDay());
...
// auto skin = ObjectManager::get<InterfaceSkinObject>();
// if (SceneManager::isNetworked())
// Dropdown::add(0, StringIds::menu_sprite_stringid, { (uint32)skin->img + InterfaceSkin::ImageIds::phone, StringIds::chat_send_message });
// Dropdown::add(1, StringIds::menu_sprite_stringid, { (uint32)skin->img + map_sprites_by_rotation[WindowManager::getCurrentRotation()], StringIds::menu_map });
// Dropdown::showBelow(self, widgetIndex, 2, 25, (1 << 6));
// Dropdown::setHighlightedItem(1);
// else
// Dropdown::add(0, StringIds::menu_sprite_stringid, { (uint32)skin->img + map_sprites_by_rotation[WindowManager::getCurrentRotation()], StringIds::menu_map });
...
// break;
// // 0x00439944
// static Ui::CursorId onCursor([[maybe_unused]] Ui::Window& self, WidgetIndex_t widgetIdx, [[maybe_unused]] const WidgetId id, [[maybe_unused]] int16 xPos, [[maybe_unused]] int16 yPos, Ui::CursorId fallback)
// switch (widgetIdx)
// case Widx::date_btn:
...
// uint16 yearsLeft = monthsLeft / 12;
