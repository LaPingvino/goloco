...
// // 0x0042A8B9
// func ScrollMouseDown(self Ui::Window, x [[maybe_unused]] int16, y int16, scrollIndex [[maybe_unused]] uint8)
...
// int32 pan = self.width / 2 + self.x;
// Audio::playSound(Audio::SoundId::clickDown, pan);
// // 0x0042A87C
// func ScrollMouseOver(self Ui::Window, x [[maybe_unused]] int16, y int16, scrollIndex [[maybe_unused]] uint8)
// self.flags &= ~(WindowFlags::notScrollView);
// auto messageIndex = y / messageHeight;
...
// if (static_cast<int16>(scrollHeight) < 0)
// scrollHeight = 0;
...
// auto setting = static_cast<uint8>(Config::get().newsSettings[i]);
