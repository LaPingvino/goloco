...
// func GetSide(loc World::Pos3, mousePos Point, elTrack TrackElement, viewport Viewport) bool
...
// orphan member: return isCloserToNext;
// static std::optional<GameCommands::SignalPlacementArgs> getSignalPlacementArgsFromCursor(const int16 x, const int16 y, const bool isBothDirectons)
...
// return { args };
// func PlaceSignalGhost(args GameCommands::SignalPlacementArgs) uint32
...
// orphan member: FormatArguments args{};
// args.push<uint32>(cState.signalCost);
