...
// int16 x = window.widgets[Widx::scenario_list_btn].left + window.x;
// int16 y = window.widgets[Widx::scenario_list_btn].top + window.y;
// uint32 image_id = ImageIds::title_menu_globe_spin_0;
...
// int16 x = window.widgets[Widx::load_game_btn].left + window.x;
// int16 y = window.widgets[Widx::load_game_btn].top + window.y;
// uint32 image_id = ImageIds::title_menu_globe_spin_0;
...
// int16 x = window.widgets[Widx::tutorial_btn].left + window.x;
// int16 y = window.widgets[Widx::tutorial_btn].top + window.y;
// uint32 image_id = ImageIds::title_menu_globe_spin_0;
...
// int16 x = window.widgets[Widx::scenario_editor_btn].left + window.x;
// int16 y = window.widgets[Widx::scenario_editor_btn].top + window.y;
// uint32 image_id = ImageIds::title_menu_globe_construct_24;
...
// break;
// // 0x004390f8
// static Ui::CursorId onCursor([[maybe_unused]] Window& window, [[maybe_unused]] WidgetIndex_t widgetIdx, [[maybe_unused]] const WidgetId id, [[maybe_unused]] int16 xPos, [[maybe_unused]] int16 yPos, Ui::CursorId fallback)
