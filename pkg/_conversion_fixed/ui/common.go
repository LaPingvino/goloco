...
// func CreateNewsWindow(kWindowSize Ui::Size, widgets any /* []<Widget> */ , colour AdvancedColour, isOld bool, flags WindowFlags)
// _nState.slideInHeight = 5;
// int16 y = Ui::height() - _nState.slideInHeight;
...
// int16 x = (Ui::width() / 2) - (kWindowSize.width / 2);
...
// auto newsSettings = Config::get().newsSettings[static_cast<uint8>(messageSubType)];
...
// func If(CompanyManager::getControllingId( news->companyId == CompanyId::null || news->companyId ==) else
// soundId = mtd.sound;
// if (soundId != Audio::SoundId::null)
// int32 pan = Ui::width() / 2;
