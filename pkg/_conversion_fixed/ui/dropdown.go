...
// format_arg(uint16 value)
// type = format_arg_type::u16;
// u16 = value;
// format_arg(uint32 value)
...
// func ShowImage(x int16, y int16, width int16, height int16, heightOffset int16, colour AdvancedColour, columnCount uint8, count uint8, 0 uint8 flags =)
...
type Builder struct {
	...
	// item(static_cast<int32>(id), text);
	// return *this;

// template<typename T>
// Builder& highlight(T id)
// highlight(static_cast<int32>(id));
// return *this;
// func Create() Builder
// std::optional<DropdownItemId> getSelectedItem(int32 index);
// template<typename T>
// std::optional<T> getSelectedItem(int32 index)
