...
// uint8 _data[5] = { 0 }; // 0x1 - 0x6
// OrderRouteWaypoint(const World::TilePos2& pos, const uint8 baseZ, const uint8 direction, const uint8 trackId)
// setType(kType);
...
func (o *OrderCargo) GetCargo() uint8 {
	// void setCargo(const uint8 cargo)
	// _type &= ~0xF8;
	// _type |= (cargo & 0x1F) << 3;
