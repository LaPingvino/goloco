...
// // e.g. uint8 a = 5; add(a, 254); a == 255; <--reaches upper limit
type Add struct {
...
// // Note: Does not work for 64bit or bigger fields
// // e.g. uint8 a = 5; sub(a, 254); a == 0; <--reaches lower limit
type Sub struct {
	// template<typename T, typename U>
...
// template<typename T, typename U>
// func Add(lhs T, rhs U) T
// return Op::Add{}(lhs, rhs);
// static_assert(add(static_cast<uint8>(5), 254) == 255);
// template<typename T, typename U>
// func Sub(lhs T, rhs U) T
