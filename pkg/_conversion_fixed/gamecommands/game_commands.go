...
// struct
	...
	Ah int8
// union
// orphan member: int32 ebx{ kDefaultRegValue };
// orphan member: int16 bx;
// struct
// orphan member: int8_t bl;
// orphan member: int8_t bh;
// union
// orphan member: int32 ecx{ kDefaultRegValue };
// orphan member: int16 cx;
// struct
// orphan member: int8_t cl;
// orphan member: int8_t ch;
// union
// orphan member: int32 edx{ kDefaultRegValue };
// orphan member: int16 dx;
// struct
// orphan member: int8_t dl;
// orphan member: int8_t dh;
// union
// orphan member: int32 esi{ kDefaultRegValue };
// orphan member: int16 si;
// union
// orphan member: int32 edi{ kDefaultRegValue };
// orphan member: int16 di;
// union
// orphan member: int32 ebp{ kDefaultRegValue };
// orphan member: int16 bp;
...
// // regs.ebp = reinterpret_cast<uint32>(filename);
