...
type CompanyUnk25C0HashTableEntry struct {
	...
	Unk25C0HashTableEntry(WorldPos3 pos, uint8 trackRoadId, uint8 direction)
	// constexpr World::Pos3 getPosition() const
func init() {
	return WorldPos3(var_00, var_02 & 0xFFFE, var_04 * 4 /*World.kSmallZStep*/)
...
type AvailableTracksAndRoads = any /* sfl::static_vector<uint8, Limits::kMaxRoadObjects + Limits::kMaxTrackObjects> */ 
