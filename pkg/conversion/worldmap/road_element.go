...
func (r *RoadElement) Rotation() uint8 {
...
// static_assert(sizeof(RoadElement) == kTileElementSize);
	// method: bool updateLevelCrossingAnimation(const Animation& anim);
}
const RoadElementElementType ElementType = ElementType.road
