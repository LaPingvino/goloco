...
type SignalElementSide struct {
	4 uint8
	5 uint8
func (s *SignalElement) HasSignal() bool {
...
// Side sides[2];
func (s *SignalElement) Rotation() uint8 {
...
// static_assert(sizeof(SignalElement) == kTileElementSize);
	// method: bool updateSignalAnimation(const Animation& anim);
}
