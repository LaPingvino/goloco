...
// orphan member: uint32_t itemHover;
// if (y < 0)
// itemHover = (1 << index);
// else
// itemHover = 0;
...
// if (y < 0)
// break;
// func If(legendItemHeight any /* cursorPos.y < static_cast<int16_t>(legendLengths[self->currentTab] */ ) else
// y = cursorPos.y;
...
// // 0x0046B9E7
// func GetScrollSize(self [[maybe_unused]] Window, scrollIndex [[maybe_unused]] uint32_t, scrollWidth int32, scrollHeight int32) 
...
// // 0x0046B97C
// func ScrollMouseDown(self [[maybe_unused]] Window, x int16, y int16, scrollIndex [[maybe_unused]] uint8_t) 
