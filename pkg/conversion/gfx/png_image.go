...
// imageData[index + 2],
// imageData[index + 3]
// func LibpngErrorHandler(png_structp, error_msg png_const_charp) 
// throw std::runtime_error(error_msg);
// func LibpngWarningHandler(png_structp, error_msg png_const_charp) 
