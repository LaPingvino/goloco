...
// MALFORMED FIELD: const WidgetIdNone any = ValueType.none
...
// // Flag *MUST* be removed before passing to drawingCtx.drawImage functions
	// method: constexpr Widget(WidgetId widgetId, Ui::Point origin, Ui::Size size, WidgetType widgetType, WindowColour colour, uint32 content = Widget::kContentNull, StringId tooltip = StringIds::null)
// : id{ widgetId }
// , content{ content }
// , left{ static_cast<int16>(origin.x) }
// , right{ static_cast<int16>(origin.x + size.width - 1) }
// , top{ static_cast<int16>(origin.y) }
// , bottom{ static_cast<int16>(origin.y + size.height - 1) }
// , tooltip{ tooltip }
// , type{ widgetType }
// , windowColour{ colour }
// SKIPPED CONSTRUCTOR: const WidgetImageIdColourSet uint32 = (1 << 30)
...
// union
// orphan member: uint32 image{ ImageIds::null };
// orphan member: StringId text;
// orphan member: uint32 content;
// orphan member: int32 left{};
// orphan member: int32 right{};
// orphan member: int32 top{};
// orphan member: int32 bottom{};
...
// orphan member: uint32 styleData{};
// // Widget state.
// bool disabled : 1 {};
// bool activated : 1 {};
// bool hidden : 1 {};
...
// func LeftAlignTabs(window Window, firstTabIndex uint8, lastTabIndex uint8, kDefaultTabWidth uint16 tabWidth =) 
...
// func MakeWidget(origin Ui::Point, size Ui::Size, type WidgetType, colour WindowColour, Widget::kContentNull uint32 content =, StringIds::null StringId tooltip =) Widget
