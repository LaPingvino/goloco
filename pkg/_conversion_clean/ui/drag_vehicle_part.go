...
// uint16 width = getWidthVehicleInline(car);
...
// // 0x004B62FE
// static Ui::CursorId cursor(Window& self, [[maybe_unused]] const WidgetIndex_t widgetIdx, [[maybe_unused]] const WidgetId id, [[maybe_unused]] const int16 x, [[maybe_unused]] const int16 y, [[maybe_unused]] const Ui::CursorId fallback)
...
// // 0x004B6271
// func OnMove(self Window, x [[maybe_unused]] int16, y [[maybe_unused]] int16)
