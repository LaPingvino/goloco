...
// orphan member: return veh;
// func ConfirmComponentChange(id EntityId, windowTitle OpenLoco::StringId, windowMessage OpenLoco::StringId, windowConfirm OpenLoco::StringId) bool
...
// func SetActiveTabs(self Window) 
// func TextInput(self Window, callingWidget WidgetIndex_t, id WidgetId, input byte) 
// func RenameVehicle(self Window, widgetIndex WidgetIndex_t) 
// func SwitchTab(self Window, widgetIndex WidgetIndex_t) 
// func SetCaptionEnableState(self Window) 
// func OnPickup(self Window, pickupWidx WidgetIndex_t) 
// func Event8(self Window) 
// func Event9(self Window) 
// func GetNumCars(self Ui::Window) int
// func DrawTabs(window Window, drawingCtx Gfx::DrawingContext) 
// func PickupToolUpdate(self Window, x int16, y int16) 
// func PickupToolDown(self Window, x int16, y int16) 
// func PickupToolAbort(self Window) 
// func GetNumCars(self Ui::Window) int
// static std::optional<Vehicles::Car> getCarFromScrollView(Window& self, const int16 y);
// static std::pair<uint32, StringId> getPickupImageIdandTooltip(const Vehicles::VehicleHead& head, const bool isPlaced);
// namespace Details
...
// static constexpr Ui::Size kMaxWindowSize = { 400, 440 };
	...
	BuildNew Widx = Common.widx.tabRoute + 1
	Pickup
	Remove
	PaintBrush
	PaintColourPrimary
...
// sfl::static_vector<BodyItem, VehicleObject::kMaxBodySprites * (2 + 1)> items;
	TotalDistance int32
const HoldableWidgets uint64 = 0
...
// );
// func PaintEntireTrain(self Window) 
// func PaintToolBegin(self Window) 
// func PaintToolDown(self Window, x int16, y int16) 
// func PaintToolAbort(self Window) 
// func PaintToolDownScroll(self Window, car Vehicles::Car, x int16) 
// func IsPaintToolActive(self Window) bool
// func GetPaintToolColour(self Window) ColourScheme
// func GetBodyItemsForVehicle(vehObject VehicleObject, yaw uint8, car Vehicles::Car) BodyItems
// namespace Cargo
...
// static constexpr Ui::Size kMaxWindowSize = { 600, 440 };
	...
	Tool Widx = Common.widx.tabRoute + 1
	LocalMode
	ExpressMode
	RouteList
	OrderForceUnload
...
// );
// static int32 _ghostTrackProgress;          // 0x01136264
// static uint8 _ghostAirportNode;            // 0x01136264
// static World::Pos3 _ghostVehiclePos;         // 0x0113625E
// static StationId _ghostAirportStationId;     // 0x0113625A
// static uint32 _ghostLandTrackAndDirection; // 0x0113625A
// namespace Main
// static constexpr Ui::Size kWindowSize = { 265, 177 };
// static constexpr Ui::Size kMinWindowSize = { 192, 177 };
// static constexpr Ui::Size kMaxWindowSize = { 600, 440 };

	Viewport Widx = Common.widx.tabRoute + 1
	Status Widx = 10
	SpeedControl Widx = 11
	StopStart Widx = 12
	Pickup Widx = 13
	PassSignal Widx = 14
	ChangeDirection Widx = 15
	CentreViewport Widx = 16
// static constexpr auto widgets = makeWidgets(
...
// );
// SKIPPED CONSTRUCTOR: const InteractiveWidgets uint64 = (1 << widx.stopStart) | (1 << widx.pickup) | (1 << widx.passSignal) | (1 << widx.changeDirection) | (1 << widx.centreViewport)
const HoldableWidgets uint64 = 1 << widx.speedControl
// // 0x004B5D82
// func ResetDisabledWidgets(self Window) 
// self.disabledWidgets = 0;
// // 0x004B5D88
// // 0x004B32F9
// func CreateViewport(self Window) 
...
// self.invalidate();
// static constexpr uint16 rowHeights[vehicleTypeCount] = {
// 22,
// 22,
// 22,
// 22,
...
// self->rowHeight = rowHeights[static_cast<uint8>(vehicle->vehicleType)];
// self->currentTab = 0;
// self->frameNo = 0;
...
// orphan member: return self;
// // 0x004B288F
// func OnChangeDirection(self Window) 
...
// func OnCentreViewportControl(self Window) 
...
// if (head == nullptr)
// return;
// uint16 newWidth = self.width - 30;
// if (head->owner != CompanyManager::getControllingId())
// newWidth += 22;
// uint16 newHeight = self.height - 59;
...
// createViewport(self);
// // 0x004B274B
// func StopStartOpen(self Window) 
...
// // 0x004B2637
// func OnSpeedControl(self Window) 
...
// break;
// // 0x004B253A
// func OnStopStartDropdown(self Window, itemIndex int16) 
...
// orphan member: VehicleChangeRunningModeArgs vargs{};
// vargs.head = EntityId(self.number);
// vargs.mode = mode;
// GameCommands::doCommand(vargs, GameCommands::Flags::apply);
// func OnCentreViewportDropdown(self Window, itemIndex int16) 
// if (itemIndex <= 0)
...
// // 0x004B255B
// func OnToolAbort(self Window, widgetIndex WidgetIndex_t, id [[maybe_unused]] WidgetId) 
// if (widgetIndex != widx::pickup)
// return;
...
// args.push(head->name);
// args.push(head->ordinalNumber);
// uint32 stopStartImage = ImageIds::red_flag;
// if (head->hasVehicleFlags(Vehicles::VehicleFlags::manualControl))
// stopStartImage = ImageIds::yellow_flag;
// func If(head->hasVehicleFlags(Vehicles::VehicleFlags::commandStop) else
...
// break;
// // 0x4B38FA
// func GetScrollSize(self Ui::Window, scrollIndex [[maybe_unused]] uint32, scrollWidth [[maybe_unused]] int32, scrollHeight int32) 
// scrollHeight = static_cast<int32>(Common::getNumCars(self) * self.rowHeight);
// // 0x004B3B54
// func ScrollMouseDown(self Window, x [[maybe_unused]] int16, y int16, scrollIndex [[maybe_unused]] uint8) 
// auto head = Common::getVehicle(self);
// if (head == nullptr)
// return;
// if (head->owner != CompanyManager::getControllingId())
...
// break;
// // 0x004B399E
// func ScrollMouseOver(self Window, x [[maybe_unused]] int16, y int16, scrollIndex [[maybe_unused]] uint8) 
...
// orphan member: FormatArguments args{};
// args.push<uint32>(StringManager::internalLengthToComma1DP(vehicleObj->getLength()));
...
// orphan member: return args;
// // 0x004B3B18
// static Ui::CursorId cursor(Window& self, const WidgetIndex_t widgetIdx, [[maybe_unused]] const WidgetId id, [[maybe_unused]] const int16 x, const int16 y, const Ui::CursorId fallback)
...
// static const std::map<VehicleType, uint32> additionalVehicleButtonByVehicleType{
...
VehicleDetailsOffset = 2 // auto
VehicleDetailsLineHeight = 12 // auto
VehicleDetailsTextHeight2Lines = kVehicleDetailsOffset + kVehicleDetailsLineHeight * 2 // auto
VehicleDetailsTextHeight3Lines = kVehicleDetailsOffset + kVehicleDetailsLineHeight * 3 // auto
// func GetVehicleDetailsHeight(transportMode OpenLoco::TransportMode) any
...
// func AlignToRightBar(self Window, widget widx) 
...
// if (obj == nullptr)
// return;
// constexpr const uint8 drawYaw = 40;
...
// uint16 textRightEdge = isPaintToolActive(self) ? self.width - 39 : self.width;
// auto head = Common::getVehicle(self);
// if (head == nullptr)
// return;
// OpenLoco::Vehicles::Vehicle train{ *head };
// Ui::Point pos = { static_cast<int16>(self.x + 3), static_cast<int16>(self.y + self.height - getVehicleDetailsHeight(head->getTransportMode()) + kVehicleDetailsOffset) };
// orphan member: FormatArguments args{};
// args.push(train.veh2->totalPower);
// args.push<uint32>(train.veh2->totalWeight);
...
// tr.drawStringLeftClipped(pos, std::min<uint16>(self.width - 6, textRightEdge), Colour::black, str, args);
// pos.y += kVehicleDetailsLineHeight;
// orphan member: FormatArguments args{};
// args.push<uint16>(train.veh2->maxSpeed == kSpeed16Null ? 0 : train.veh2->maxSpeed.getRaw());
// args.push<uint16>(train.veh2->rackRailMaxSpeed == kSpeed16Null ? 0 : train.veh2->rackRailMaxSpeed.getRaw());
// args.push<uint16>(train.veh2->reliability == 0 ? 64 : train.veh2->reliability);
...
// tr.drawStringLeftClipped(pos, std::min<uint16>(self.width - 16, textRightEdge), Colour::black, str, args);
// // Draw car count and vehicle length
// pos.y += kVehicleDetailsLineHeight;
// FormatArguments args = {};
// StringId str = StringIds::vehicle_length;
// args.push<uint32>(StringManager::internalLengthToComma1DP(head->getVehicleTotalLength()));
// if (train.veh2->mode == TransportMode::rail && head->getCarCount() > 1)
// str = StringIds::vehicle_car_count_and_length;
// args.push<uint32>(head->getCarCount());
// tr.drawStringLeftClipped(pos, std::min<uint16>(self.width - 16, textRightEdge), Colour::black, str, args);
// // 0x004B36A3
// func DrawScroll(self Window, drawingCtx Gfx::DrawingContext, i [[maybe_unused]] uint32) 
// auto tr = Gfx::TextRenderer(drawingCtx);
...
// int16 top = pos.y;
// int16 bottom = pos.y + self.rowHeight - 1;
...
// int16 y = pos.y + (self.rowHeight - 22) / 2;
...
// orphan member: return nullptr;
// orphan member: return vehicleWindow;
...
// func If(5 pos.y > vehicleWindow->widgets[widx::carList].bottom + vehicleWindow->y -) else
...
// func GetBodyItemsForVehicle(vehObject VehicleObject, yaw uint8, car Vehicles::Car) BodyItems
// const auto getScreenDistance = [](int32 gameDist, uint8 yaw) {
...
// else
// componentIndex++;
// orphan member: return bodyItems;
// namespace Cargo
// func OnRefitButton(self Window, wi WidgetIndex_t, id WidgetId) 
// func CanRefit(headVehicle Vehicles::VehicleHead) bool
...
// // based on 0x004B40C7
// func DrawCargoText(drawingCtx Gfx::DrawingContext, x int16, y int16, strFormat StringId, cargoQty uint8, cargoType uint8, stationId StationId) 
// if (cargoQty == 0)
// return;
// auto tr = Gfx::TextRenderer(drawingCtx);
...
// int16 cargoTextYPos = y + self.rowHeight / 2 - ((self.rowHeight - 22) / 2) - 10;
...
// y += self.rowHeight;
// // 0x004B41BD
// func OnMouseUp(self Window, i WidgetIndex_t, id [[maybe_unused]] WidgetId) 
// switch (i)
// case Common::widx::closeButton:
// WindowManager::close(&self);
// break;
...
// break;
// // 0x004B41E2
// func OnMouseDown(self Window, i WidgetIndex_t, id [[maybe_unused]] WidgetId) 
// switch (i)
// case widx::refit:
// onRefitButton(self, i, id);
// break;
// // 0x004B41E9
// func OnDropdown(self Window, i WidgetIndex_t, id [[maybe_unused]] WidgetId, dropdownIndex int16) 
// switch (i)
// case widx::refit:
// if (dropdownIndex == -1)
// break;
...
// GameCommands::doCommand(args, GameCommands::Flags::apply);
// break;
// func OnRefitButton(self Window, wi WidgetIndex_t, id [[maybe_unused]] WidgetId) 
// auto* head = Common::getVehicle(self);
// if (head == nullptr)
// return;
// Vehicles::Vehicle train(*head);
...
// int32 index = 0;
// for (uint16 cargoId = 0; cargoId < ObjectManager::getMaxObjects(ObjectType::cargo); cargoId++)
...
// args.push<uint32>(Vehicles::getNumUnitsForCargo(maxPrimaryCargo, primaryCargoId, cargoId));
// args.push<uint16>(cargoId);
...
// func GetScrollSize(self Ui::Window, scrollIndex [[maybe_unused]] uint32, scrollWidth [[maybe_unused]] int32, scrollHeight int32) 
// scrollHeight = static_cast<int32>(Common::getNumCars(self) * self.rowHeight);
// static char* generateCargoTooltipDetails(char* buffer, const StringId cargoFormat, const uint8 cargoType, const uint8 maxCargo, const uint32 acceptedCargoTypes)
// if (cargoType == 0xFF)
// orphan member: return buffer;
// auto cargoObj = ObjectManager::get<CargoObject>(cargoType);
// orphan member: FormatArguments args{};
// args.push(maxCargo == 1 ? cargoObj->unitNameSingular : cargoObj->unitNamePlural);
// args.push<uint32>(maxCargo);
...
// orphan member: FormatArguments args{};
// args.push<uint32>(veh1->lastIncome.day);
...
// orphan member: FormatArguments args{};
// args.push(str);
// args.push<uint32>(veh1->lastIncome.cargoQtys[i]);
// args.push(veh1->lastIncome.cargoDistances[i]);
// args.push<uint16>(veh1->lastIncome.cargoAges[i]);
...
// if (ToolManager::isToolActive(self.type, self.number))
// ToolManager::toolCancel();
// func OrderDeleteCommand(head Vehicles::VehicleHead, orderOffset uint32) 
...
// // 0x004B4F6D
// func OnOrderDelete(head Vehicles::VehicleHead, orderId int16) 
// // No deletable orders
...
// // 0x004B4C14
// func OrderUpCommand(head Vehicles::VehicleHead, orderOffset uint32) bool
...
// // 0x004B4CCB based on
// func OrderDownCommand(head Vehicles::VehicleHead, orderOffset uint32) bool
...
// Vehicles::OrderManager::generateNumDisplayFrames(head); // Note: order changed, check if this matters.
// return result != GameCommands::FAILURE;
// func OrderReverseCommand(head Vehicles::VehicleHead) bool
...
// func OnOrderMove(head Vehicles::VehicleHead, orderId int16, bool(orderMoveFunc) bool
// // No moveable orders
// if (head->sizeOfOrderTable <= 1)
// orphan member: return false;
...
// if (order != nullptr)
// func OrderMoveFunc(head, order->getOffset() return
// orphan member: return false;
// // 0x004B4B43
// func OnMouseUp(self Window, widgetIndex WidgetIndex_t, id [[maybe_unused]] WidgetId) 
// auto* head = Common::getVehicle(self);
...
// GameCommands::setErrorTitle(StringIds::empty);
// orphan member: VehicleChangeRunningModeArgs args{};
// args.head = head->id;
...
// self.setSize(kMinWindowSize, kMaxWindowSize);
// // 0x004B4DD3
// func CreateOrderDropdown(self Window, i WidgetIndex_t, orderType StringId) 
// auto head = Common::getVehicle(self);
// if (head == nullptr)
// return;
// auto index = 0;
...
// // 0x004B4ECB
// func AddNewOrder(self Window, order Vehicles::Order) 
// auto head = Common::getVehicle(self);
// if (head == nullptr)
// return;
...
// orphan member: return args;
// // 0x004B5BB9
// static ViewportInteraction::InteractionArg stationLabelAdjustedInteraction(const Vehicles::VehicleHead& head, int16 orderTableIndex, StationId stationId, ViewportInteraction::InteractionArg interaction)
// auto* station = StationManager::get(stationId);
// if (station == nullptr)
...
// // 0x004B5BA3
// static ViewportInteraction::InteractionArg stationAdjustedInteraction(const Vehicles::VehicleHead& head, int16 orderTableIndex, World::TileElementBase* el, ViewportInteraction::InteractionArg interaction)
// auto* elStation = el->as<StationElement>();
// if (elStation == nullptr)
// return ViewportInteraction::kNoInteractionArg;
// if (elStation->isAiAllocated() || elStation->isGhost())
// return ViewportInteraction::kNoInteractionArg;
// func StationLabelAdjustedInteraction(head, orderTableIndex, elStation->stationId() return
// // 0x004B5B92
// static ViewportInteraction::InteractionArg trainStationAdjustedInteraction(const Vehicles::VehicleHead& head, int16 orderTableIndex, ViewportInteraction::InteractionArg interaction)
...
// return ViewportInteraction::kNoInteractionArg;
// func StationAdjustedInteraction(head, orderTableIndex, elStation, interaction) return
// // 0x004B5AC9
// static ViewportInteraction::InteractionArg trackAdjustedInteraction(const Vehicles::VehicleHead& head, int16 orderTableIndex, ViewportInteraction::InteractionArg interaction)
// auto* el = static_cast<TileElement*>(interaction.object);
...
// func TrainStationAdjustedInteraction(head, orderTableIndex, arg) return
// if (head.mode == TransportMode::water || head.mode == TransportMode::air)
// return ViewportInteraction::kNoInteractionArg;
// FormatArguments::mapToolTip(StringIds::click_to_insert_new_order_route_through);
// orphan member: return interaction;
// // 0x004B5AC9
// static ViewportInteraction::InteractionArg roadAdjustedInteraction(const Vehicles::VehicleHead& head, int16 orderTableIndex, ViewportInteraction::InteractionArg interaction)
// auto* el = static_cast<TileElement*>(interaction.object);
...
// orphan member: return interaction;
// // 0x004B5B7F
// static ViewportInteraction::InteractionArg dockAirportAdjustedInteraction(const Vehicles::VehicleHead& head, int16 orderTableIndex, ViewportInteraction::InteractionArg interaction)
// auto* el = static_cast<TileElement*>(interaction.object);
// auto* elStation = el->as<StationElement>();
// if (elStation == nullptr)
// return ViewportInteraction::kNoInteractionArg;
...
// orphan member: return interaction;
// // 0x004B5A1A
// static Ui::ViewportInteraction::InteractionArg getRouteInteractionFromCursor(Window& self, const int16 x, const int16 y)
// auto head = Common::getVehicle(self);
...
// func TrackAdjustedInteraction(head, self.orderTableIndex, interaction) return
// case ViewportInteraction::InteractionItem::road:
// func RoadAdjustedInteraction(head, self.orderTableIndex, interaction) return
// case ViewportInteraction::InteractionItem::trainStation:
// func TrainStationAdjustedInteraction(head, self.orderTableIndex, interaction) return
// case ViewportInteraction::InteractionItem::roadStation:
// func StationAdjustedInteraction(head, self.orderTableIndex, any /* static_cast<TileElement>(interaction.object */ ) return
// case ViewportInteraction::InteractionItem::airport:
// case ViewportInteraction::InteractionItem::dock:
// func DockAirportAdjustedInteraction(head, self.orderTableIndex, interaction) return
// case ViewportInteraction::InteractionItem::stationLabel:
// func StationLabelAdjustedInteraction(head, self.orderTableIndex, any /* static_cast<StationId>(interaction.value */ ) return
// case ViewportInteraction::InteractionItem::water:
// func WaterAdjustedInteraction(head, interaction) return
// default:
// return ViewportInteraction::kNoInteractionArg;
// // 0x004B5088
// func ToolCancel(self Window, widgetIdx [[maybe_unused]] WidgetIndex_t, id [[maybe_unused]] WidgetId) 
// self.invalidate();
...
// break;
// // 0x004B50CE
// static Ui::CursorId toolCursor(Window& self, const int16 x, const int16 y, const Ui::CursorId fallback, bool& out)
// const auto args = getRouteInteractionFromCursor(self, x, y);
...
// self.invalidate();
// // 0x004B5339
// static Ui::CursorId cursor(Window& self, const WidgetIndex_t widgetIdx, [[maybe_unused]] const WidgetId id, [[maybe_unused]] const int16 x, [[maybe_unused]] const int16 y, const Ui::CursorId fallback)
...
// // 0x004B4A58 based on
// func DrawOrderLabel(self Window, drawingCtx Gfx::DrawingContext, strFormat StringId, args FormatArguments, order Vehicles::Order, y int16, orderNumber int16) 
// auto tr = Gfx::TextRenderer(drawingCtx);
// char buffer[512];
...
// orphan member: FormatArguments args{};
// args.push(orderString[static_cast<uint8>(order.getType())]);
...
// Ui::Point loc = { 8, static_cast<int16>(rowNum * lineHeight) };
// auto strFormat = StringIds::black_stringid;
// if (self.orderTableIndex == rowNum)
...
// GameCommands::doCommand(args, GameCommands::Flags::apply);
// // 0x0050029C
// static constexpr []<[]<CursorId, 2>, 6> kTypeToToolCursor = {
...
// // 0x00427595
// static std::optional<GameCommands::VehicleWaterPlacementArgs> getVehicleWaterPlacementArgsFromCursor(const Vehicles::VehicleHead& head, const int16 x, const int16 y)
...
// if (bestDistance == std::numeric_limits<int32>::max())
// return {};
// GameCommands::VehicleWaterPlacementArgs args;
// args.pos = bestLoc;
// args.head = head.id;
// return { args };
// func RemoveBoatGhost(head Vehicles::VehicleHead) 
...
// // 0x004B2B9E
// func PickupToolUpdateWater(head Vehicles::VehicleHead, x int16, y int16) 
...
// // 0x00426F0B
// static std::optional<GameCommands::VehicleAirPlacementArgs> getVehicleAirPlacementArgsFromCursor(const Vehicles::VehicleHead& head, const int16 x, const int16 y)
...
// func RemoveAirplaneGhost(head Vehicles::VehicleHead) 
// // Note: don't use isPlaced as we need to know if its a ghost
// // consider creating isGhostPlaced
// if (head.tileX != -1 && head.has38Flags(Vehicles::Flags38::isGhost))
...
// // 0x004B2AFA
// func PickupToolUpdateAir(head Vehicles::VehicleHead, x int16, y int16) 
...
// // 0x004A43E4
// func GetRoadProgressAtCursor(cursorLoc Point, viewport Ui::Viewport, roadElement RoadElement, loc World::Pos3) uint16
...
// uint16 trackAndDirection = roadElement.rotation() | (roadElement.roadId() << 3);
...
// orphan member: return bestProgress;
// // 0x00478415
// static std::optional<GameCommands::VehiclePlacementArgs> getRoadAtCursor(const int16 x, const int16 y)
...
// return { placementArgs };
// // 0x00479707
// static std::optional<GameCommands::VehiclePlacementArgs> getVehicleRoadPlacementArgsFromCursor(const Vehicles::VehicleHead& head, const int16 x, const int16 y)
...
// uint8 unkYaw = moveInfo.yaw + (WindowManager::getCurrentRotation() << 4);
// unkYaw -= 0x37;
...
// placementArgs->trackProgress = std::max<uint16>(static_cast<uint16>(moveInfoArr.size()) - placementArgs->trackProgress, 0);
// if (placementArgs->trackProgress >= moveInfoArr.size())
// placementArgs->trackProgress = static_cast<uint16>(moveInfoArr.size()) - 1;
// placementArgs->trackAndDirection ^= (1 << 2);
// orphan member: return placementArgs;
// // 0x004A43E4
// func GetTrackProgressAtCursor(cursorLoc Point, viewport Ui::Viewport, trackElement TrackElement, loc World::Pos3) uint16
...
// uint16 trackAndDirection = trackElement.rotation() | (trackElement.trackId() << 3);
...
// orphan member: return bestProgress;
// // 0x004A40C5
// static std::optional<GameCommands::VehiclePlacementArgs> getTrackAtCursor(const int16 x, const int16 y)
...
// return { placementArgs };
// // 0x004B6444
// static std::optional<GameCommands::VehiclePlacementArgs> getVehicleRailPlacementArgsFromCursor(const Vehicles::VehicleHead& head, const int16 x, const int16 y)
...
// placementArgs->trackAndDirection ^= (1 << 2);
// orphan member: return placementArgs;
// func RemoveLandGhost(head Vehicles::VehicleHead) 
// // Note: don't use isPlaced as we need to know if its a ghost
// // consider creating isGhostPlaced
// if (head.tileX != -1 && head.has38Flags(Vehicles::Flags38::isGhost))
...
// func PickupToolUpdateLand(head Vehicles::VehicleHead, x int16, y int16, getPlacementArgs GetPlacementArgsFunc) 
...
// if (head == nullptr)
// return;
// ToolManager::setToolCursor(kTypeToToolCursor[static_cast<uint8>(head->vehicleType)][getGameState().pickupDirection != 0 ? 1 : 0]);
// switch (head->mode)
// case TransportMode::rail:
...
// break;
// // 0x004B2D8A
// func PickupToolError(head Vehicles::VehicleHead) 
// auto args = FormatArguments::common();
// args.skip(6);
// args.push(head.name);
// args.push(head.ordinalNumber);
// Error::open(StringIds::cant_place_string_id_here, StringIds::null);
// func PickupToolPlacementCommandCallback(gameCommandResult uint32, self Window, vehicleHead EntityId) 
...
// // 0x004B2E18
// func PickupToolDownAir(self Window, head Vehicles::VehicleHead, x int16, y int16) 
// auto placementArgs = getVehicleAirPlacementArgsFromCursor(head, x, y);
// if (!placementArgs)
...
// // 0x004B2F1C
// func PickupToolDownWater(self Window, head Vehicles::VehicleHead, x int16, y int16) 
// auto placementArgs = getVehicleWaterPlacementArgsFromCursor(head, x, y);
// if (!placementArgs)
// pickupToolError(head);
// return;
...
// // 0x004B2C95
// template<typename GetPlacementArgsFunc>
// func PickupToolDownLand(self Window, head Vehicles::VehicleHead, x int16, y int16, getPlacementArgs GetPlacementArgsFunc) 
// auto placementArgs = getPlacementArgs(head, x, y);
// if (!placementArgs)
// pickupToolError(head);
// return;
...
// orphan member: FormatArgumentsBuffer buffer{};
...
// return;
// if (!head->isPlaced())
// CursorId cursor = kTypeToToolCursor[static_cast<uint8>(head->vehicleType)][getGameState().pickupDirection != 0 ? 1 : 0];
...
// orphan member: return true;
// func If(Common::widx::tabMain w->currentTab == (Common::widx::tabRoute -) else
