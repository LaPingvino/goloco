...
// window->rowCount = static_cast<uint16>(ShortcutManager::getList().size());
// window->rowHover = -1;
// orphan member: return window;
// // 0x004BE726
...
// static const std::unordered_map<uint32, StringId> keysToString = { {
...
// func If(KeyModifier::control (shortcut.modifiers) else
