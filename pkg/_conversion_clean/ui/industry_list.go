...
// static uint8 _industryGhostType;          // 0x00E0C3DA
...
// uint8 productionTransported = 0xFFU;
...
// static std::pair<uint32, StringId> getProductionLastMonth(const OpenLoco::Industry& industry)
// auto industryObj = ObjectManager::get<IndustryObject>(industry.objectId);
// auto cargoProduction = std::numeric_limits<uint32>::max();
...
// orphan member: FormatArguments args{};
// args.push<uint16>(productionTransported);
...
// args.push<uint32>(productionTransported.first);
...
// // 0x00458966
// func OnScrollMouseDown(self Ui::Window, x int16, y int16, scrollIndex [[maybe_unused]] uint8)
...
// break;
// // 0x00458721
// func OnScrollMouseOver(self Ui::Window, x int16, y int16, scrollIndex [[maybe_unused]] uint8)
// auto index = getRowIndex(x, y);
...
// orphan member: return res;
// // 0x0045857B
// static std::optional<GameCommands::IndustryPlacementArgs> getIndustryPlacementArgsFromCursor(const int16 x, const int16 y)
...
// for (uint16 i = 0; i < ObjectManager::getMaxObjects(ObjectType::industry); i++)
...
// static constexpr uint32 fundNewIndustriesImageIds[] = {
