...
// static uint8 _buildingGhostType;          // 0x01135C62
// static uint8 _buildingRotation;           // 0x01135C63
// static uint8 _buildingGhostRotation;      // 0x01135C64
// static uint8 _buildingVariation;          // 0x01135C65
// static uint8 _townSize;                   // 0x01135C66
// namespace Common
type Widx int
...
// // 0x0049A0F8
// func DrawScroll(self Ui::Window, drawingCtx Gfx::DrawingContext, scrollIndex [[maybe_unused]] uint32)
...
// orphan member: FormatArguments args{};
// args.push(StringIds::int_32);
// args.push<int32>(town->numStations);
...
// break;
// // 0x0049A56D
// func OnScrollMouseDown(self Ui::Window, x [[maybe_unused]] int16, y int16, scroll_index [[maybe_unused]] uint8)
// uint16 currentRow = y / kRowHeight;
// if (currentRow > self.var_83C)
// return;
// int16 currentTown = self.rowInfo[currentRow];
// if (currentTown == -1)
// return;
// Town::open(currentTown);
// // 0x0049A532
// func OnScrollMouseOver(self Ui::Window, x [[maybe_unused]] int16, y int16, scroll_index [[maybe_unused]] uint8)
...
// // 0x004919A4
// static Ui::CursorId cursor(Window& self, WidgetIndex_t widgetIdx, [[maybe_unused]] const WidgetId id, [[maybe_unused]] int16 xPos, int16 yPos, Ui::CursorId fallback)
// if (widgetIdx != widx::scrollview)
// orphan member: return fallback;
// uint16 currentIndex = yPos / kRowHeight;
...
// // 0x0049B3B2
// static std::optional<GameCommands::BuildingPlacementArgs> getBuildingPlacementArgsFromCursor(const int16 x, const int16 y)
...
// // 0x0049AEFD
// func OnScrollMouseDown(self Ui::Window, x int16, y int16, scroll_index [[maybe_unused]] uint8)
...
// if (self.currentTab == Common::widx::tab_build_misc_buildings - Common::widx::tab_town_list)
// getGameState().lastMiscBuildingOption = static_cast<uint8>(rowInfo);
// else
// getGameState().lastBuildingOption = static_cast<uint8>(rowInfo);
...
// break;
// // 0x0049AEBA
// func OnScrollMouseOver(self Ui::Window, x int16, y int16, scroll_index [[maybe_unused]] uint8)
// auto index = getRowIndex(x, y);
// uint16 rowInfo = y;
// auto i = 0;
// for (; i < self.var_83C; i++)
...
// // Build New Towns Tab
// static constexpr uint32 buildNewTownsImageIds[] = {
...
// static constexpr uint32 buildBuildingsImageIds[] = {
...
// static constexpr uint32 buildMiscBuildingsImageIds[] = {
