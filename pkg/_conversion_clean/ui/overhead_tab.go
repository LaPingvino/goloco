...
// static std::optional<GameCommands::RoadModsPlacementArgs> getRoadModsPlacementArgsFromCursor(const int16 x, const int16 y)
...
// return { args };
// static std::optional<GameCommands::TrackModsPlacementArgs> getTrackModsPlacementArgsFromCursor(const int16 x, const int16 y)
...
// func PlaceRoadModGhost(args GameCommands::RoadModsPlacementArgs) uint32
...
// func PlaceTrackModGhost(args GameCommands::TrackModsPlacementArgs) uint32
// auto res = GameCommands::doCommand(args, GameCommands::Flags::apply | GameCommands::Flags::preventBuildingClearing | GameCommands::Flags::noErrorWindow | GameCommands::Flags::noPayment | GameCommands::Flags::ghost);
// if (res != GameCommands::FAILURE)
// Common::setGhostVisibilityFlag(GhostVisibilityFlags::overhead);
// auto& cState = getConstructionState();
...
// Ui::Point screenPos = { static_cast<int16>(rotCoord.y - rotCoord.x), static_cast<int16>(((rotCoord.x + rotCoord.y) >> 1) - 460) };
...
// args.push<uint32>(cState.modCost);
