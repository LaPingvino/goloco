...
// static uint16 _lineBreakCount; // 0x01136F90
type Widx int
...
// func Common(window [[maybe_unused]] Window, widgetIndex [[maybe_unused]] int32, stringId StringId, cursorX int16, cursorY int16, args FormatArguments)
// StringManager::formatString(_text, stringId, args);
// const auto font = Gfx::Font::medium_bold;
// int16 strWidth = Gfx::TextRenderer::getStringWidthNewLined(font, _text);
// strWidth = std::min<int16>(strWidth, 196);
