...
// SKIPPED CONSTRUCTOR: 	WhiteBorderMask       WindowFlags = whiteBorderOne | (1 << 18)
...
type WindowEventList struct {
	...
	// void (*onDropdown)(Window&, WidgetIndex_t, WidgetId, int16) = nullptr;
	// void (*onPeriodicUpdate)(Window&) = nullptr;
	// void (*onUpdate)(Window&) = nullptr;
	// void (*event_08)(Window&) = nullptr;
	// void (*event_09)(Window&) = nullptr;
	// void (*onToolUpdate)(Window&, const WidgetIndex_t, WidgetId, const int16, const int16) = nullptr;
	// void (*onToolDown)(Window&, const WidgetIndex_t, WidgetId, const int16, const int16) = nullptr;
	// void (*toolDrag)(Window&, const WidgetIndex_t, WidgetId, const int16, const int16) = nullptr;
	// void (*toolUp)(Window&, const WidgetIndex_t, WidgetId, const int16, const int16) = nullptr;
	// void (*onToolAbort)(Window&, const WidgetIndex_t, WidgetId) = nullptr;
	// Ui::CursorId (*toolCursor)(Window&, const int16 x, const int16 y, const Ui::CursorId, bool&) = nullptr;
	// void (*getScrollSize)(Window&, uint32 scrollIndex, int32& scrollWidth, int32& scrollHeight) = nullptr;
	// void (*scrollMouseDown)(Ui::Window&, int16 x, int16 y, uint8 scrollIndex) = nullptr;
	// void (*scrollMouseDrag)(Ui::Window&, int16 x, int16 y, uint8 scrollIndex) = nullptr;
	// void (*scrollMouseOver)(Ui::Window& window, int16 x, int16 y, uint8 scrollIndex) = nullptr;
	...
	// Ui::CursorId (*cursor)(Window&, WidgetIndex_t, WidgetId, int16, int16, Ui::CursorId) = nullptr;
	// void (*onMove)(Window&, const int16 x, const int16 y) = nullptr;
	// void (*prepareDraw)(Window&) = nullptr;
	// void (*draw)(Window&, Gfx::DrawingContext&) = nullptr;
	// void (*drawScroll)(Window&, Gfx::DrawingContext&, const uint32 scrollIndex) = nullptr;
	// bool (*keyUp)(Window&, uint32 charCode, uint32 keyCode) = nullptr;
...
type SavedView struct {
	...
	// , rotation(rotation)
	// , surfaceZ(surfaceZ) {};
	// method: constexpr SavedView(EntityId entityId, uint16 flags, ZoomLevel zoomLevel, int8_t rotation, coord_t surfaceZ)
	// : entityId(entityId)
	// , flags(flags)
	// , zoomLevel(zoomLevel)
	// , rotation(rotation)
...
// int16 expandContentCounter = 0; // Used to delay content expand when hovering over expandable scroll content
// bool showTownNames = false;       // Map window only
// orphan member: WindowFlags flags;
// WindowNumber_t number = 0;
// orphan member: int32 x;
// orphan member: int32 y;
// orphan member: int32 width;
// orphan member: int32 height;
// orphan member: int32 minWidth;
// orphan member: int32 maxWidth;
// orphan member: int32 minHeight;
// orphan member: int32 maxHeight;
// ScrollArea scrollAreas[kMaxScrollAreas];
// int16 rowInfo[1000];
// orphan member: uint16 rowCount;
// orphan member: uint16 var_83C;
// orphan member: uint16 rowHeight;
// int16 rowHover = -1;
// union
// int16 orderTableIndex = -1;
// orphan member: int16 selectedTileIndex;
// orphan member: uint16 sortMode;
// uint16 var_846 = 0;
// uint16 var_850 = 0; // vehicle list filter
// uint16 var_852 = 0; // vehicle list cargo; news ticks
// uint16 var_854 = 0; // used to limit updates
// union
// orphan member: uint16 filterLevel;     // ObjectSelectionWindow
// orphan member: uint16 numTicksVisible; // TimePanel
// uint16 var_858 = 0;
// uint16 currentTab = 0;
// uint16 frameNo = 0;
// uint16 currentSecondaryTab = 0;
// orphan member: int16 var_88A; // map window orig width
// orphan member: int16 var_88C; // map window orig height
...
// return { width, height };
// func SetWidgets(newWidgets any /* []<Widget> */ )
// widgets.clear();
...
// Ui::CursorId callToolCursor(int16 xPos, int16 yPos, Ui::CursorId fallback, bool* out);                        // 15
...
// Ui::CursorId callCursor(WidgetIndex_t widgetIdx, WidgetId id, int16 xPos, int16 yPos, Ui::CursorId fallback); // 24
...
// World::Pos2 viewportCoordToMapCoord(int16 x, int16 y, int16 z, int32 rotation);
// std::optional<World::Pos2> screenGetMapXyWithZ(const Point& mouse, const int16 z);