...
// );
// static string _captionString;
// static uint8 _progressBarStyle = 0; // 0x005233C8
// static uint8 _progressBarValue = 0; // 0x011370A8
...
// orphan member: uint32 trainImage;
// if (_progressBarStyle == 0)
// static []<uint32, 4> style0Frames = {
...
// int16 xPos = _progressBarValue - 255;
