...
// SKIPPED C++ SYNTAX: func Button(xPos {, } yPos, width {, } height, colour, StringIds::stepper_minus, tooltip) return {
}
...
// const uint16 height = size.height - 2;
// SKIPPED C++ SYNTAX: func Button(xPos {, } yPos, width {, } height, colour, StringIds::stepper_plus, tooltip) return {
