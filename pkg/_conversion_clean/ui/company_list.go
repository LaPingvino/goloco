...
// static uint16 _hoverItemTicks;     // 0x009C68C7
...
// count++;
// _graphSettings.lineCount = count;
// _graphSettings.dataEnd = static_cast<uint16>(std::size(Economy::getDeliveryCargoPaymentsTable(0)));
// _graphSettings.dataTypeSize = 4;
...
// static constexpr uint32 performanceImageIds[] = {
...
// // Cargo Unit Tab
// static constexpr uint32 cargoUnitsImageIds[] = {
...
// // Cargo Distance Tab
// static constexpr uint32 cargoDistanceImageIds[] = {
...
// // Company Values Tab
// static constexpr uint32 companyValuesImageIds[] = {
...
// // 0x004365E4
// func DrawGraphAndLegend(self Window, drawingCtx Gfx::DrawingContext)
// auto totalMonths = (getCurrentYear() * 12) + static_cast<uint16>(getCurrentMonth());
