...
// func GetActiveObject(objectType ObjectType, objectIndexFlags any /* []<SelectedObjectsFlags> */ ) ObjIndexPair
type ObjectSelectionMeta struct {
// []<uint16, kMaxObjectTypes> numSelectedObjects;
	NumImages uint32
...
// func MarkOnlyLoadedObjects(objectFlags any /* []<SelectedObjectsFlags> */ ) 
// func LoadSelectionListObjects(objectFlags any /* []<SelectedObjectsFlags> */ ) 
// func UnloadUnselectedSelectionListObjects(objectFlags any /* []<SelectedObjectsFlags> */ ) 
// std::optional<ObjectType> validateObjectSelection([]<SelectedObjectsFlags> objectFlags);