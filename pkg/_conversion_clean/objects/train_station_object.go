...
// SKIPPED C++ SYNTAX: type CargoOffset = any /* []<World::Pos3, 2> */ 
	Name StringId
	PaintStyle uint8
	Height uint8
// World::Track::TrackTraitFlags trackPieces; // 0x04
	...
	Var_0D uint8
	Image uint32
// uint32 imageOffsets[4];        // 0x12 "sequenceIndexImageOffsets"
	NumCompatible uint8
// uint8 mods[7];                 // 0x23
	DesignedYear uint16
	ObsoleteYear uint16
// uint32 cargoOffsetBytes[4][4]; // 0x2E
// uint32 var_6E[16];
	...
	// method: void unload();
// sfl::static_vector<CargoOffset, Limits::kMaxStationCargoDensity> getCargoOffsets(const uint8 rotation, const uint8 nibble) const;
