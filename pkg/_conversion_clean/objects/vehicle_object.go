...
// SKIPPED CONSTRUCTOR: const IsReversed uint8 = (1 << 7)
...
type VehicleObject struct {
	...
	// uint16 compatibleVehicles[8];                       // 0x10 array of compatible vehicle_types
	// uint8 requiredTrackExtras[4];                       // 0x20
	...
	// uint8 maxCargo[2];                                  // 0xE2 size is relative to the first compatibleCargoCategories
	// uint32 compatibleCargoCategories[2];                // 0xE4
	// uint8 cargoTypeSpriteOffsets[32];                   // 0xEC
	...
	// method: void drawDescription(Gfx::DrawingContext& drawingCtx, const int16 x, const int16 y, const int16 width) const;
	...
	// method: void unload();
	// method: uint32 getLength() const;
	// method: constexpr bool hasFlags(VehicleObjectFlags flagsToTest) const
	// return (flags & flagsToTest) != VehicleObjectFlags::none;

// MALFORMED FIELD: const VehicleObjectObjectType any = ObjectType.vehicle
// MALFORMED FIELD: const VehicleObjectMaxBodySprites any = 4
// MALFORMED FIELD: const VehicleObjectMaxCarComponents any = 4
// MALFORMED FIELD: const VehicleObjectMaxStartSounds any = 3
