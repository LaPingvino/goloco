...
// fs::path promptDirectory(const string& title, void* hwnd)
// fs::path result;
...
// orphan member: return false;
// SKIPPED CONSTRUCTOR: type RtlGetVersionFn = LONG(WINAPI*)(PRTL_OSVERSIONINFOW)
...
// orphan member: return false;
// orphan member: return true;
// std::vector<string> getCmdLineVector(int, const char**)
...
// continue;
// // When resizing a string the null termination is handled implicitly. i.e. resize to true length not null terminated length.
