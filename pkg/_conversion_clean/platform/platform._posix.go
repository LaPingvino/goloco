...
// const int32 mib[] = { CTL_KERN, KERN_PROC, KERN_PROC_PATHNAME, -1 };
...
// fs::path promptDirectory([[maybe_unused]] const string& Title, [[maybe_unused]] void* hwnd)
// string input;
...
// std::vector<string> getCmdLineVector(int argc, const char** argv)
...
// // This is intentional.
// int32 pidFile = open(kSingleInstanceMutexName, O_CREAT | O_RDWR, 0666);
// if (pidFile == -1)
