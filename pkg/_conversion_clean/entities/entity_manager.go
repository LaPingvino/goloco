...
// template<typename T>
// SKIPPED C++ SYNTAX: type EntityListIterator = any /* ListIterator<T, &EntityBase::nextEntityId> */ 
...
// EntityId firstId = EntityId::null;
// SKIPPED C++ SYNTAX: type Iterator = any /* ListIterator<EntityBase, &EntityBase::nextQuadrantId> */ 
