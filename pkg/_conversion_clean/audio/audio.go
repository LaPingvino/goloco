...
// std::optional<uint32> getSoundSample(SoundId id);
...
// // INSTEAD USE playSound(SoundId id, const Map::Pos3& loc) OR playSound(SoundId id, int32 pan)
...
// return static_cast<int32>(id) & 0x8000;
// func MakeObjectSoundId(id SoundObjectId_t) SoundId
// return static_cast<SoundId>((static_cast<int32>(id) | 0x8000));
