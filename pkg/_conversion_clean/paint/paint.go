...
// namespace
// constexpr []<[]<uint8, 4>, 4> kSegMap1 = {
// []<uint8, 4>{ 0, 1, 2, 3 },
// []<uint8, 4>{ 2, 0, 3, 1 },
// []<uint8, 4>{ 3, 2, 1, 0 },
// []<uint8, 4>{ 1, 3, 0, 2 },
// constexpr []<[]<uint8, 4>, 4> kSegMap2 = {
// []<uint8, 4>{ 0, 1, 2, 3 },
// []<uint8, 4>{ 1, 3, 0, 2 },
// []<uint8, 4>{ 3, 2, 1, 0 },
// []<uint8, 4>{ 2, 0, 3, 1 },
...
// Ui::Point vpPos;
// World::Pos2 mapPos;
// orphan member: uint16 quadrantIndex;
// orphan member: uint8 modId; // used for track mods and signal sides
...
type BridgeEntry struct {
	...
	// method: constexpr BridgeEntry(coord_t _height, uint8 _subType, uint8 edges, uint8 quarters, uint8 _objectId, ImageId _imageBase)
...
// uint32 segmentImages[9];                                          // 0x00F003F8 0 == no support here
// uint8 segmentFrequency[9];                                        // 0x00F0041C fewer bits set == higher frequency of supports
...
// SKIPPED CONSTRUCTOR: const BridgeEntryNullBridgeEntry any = BridgeEntry(-1, 0, 0, 0, 0, ImageId(0))
...
func (p *PaintSession) GetRotation() uint8 {
	// void setRotation(uint8 rotation) { currentRotation = rotation; }
	// int16 getMaxHeight() { return _maxHeight; }
	// uint32 getRoadExits() { return _roadMergeExits; }
	// void setRoadExits(uint32 value) { _roadMergeExits = value; }
	// uint32 getMergeRoadBaseImage() { return _roadMergeBaseImage; }
	// void setMergeRoadBaseImage(uint32 value) { _roadMergeBaseImage = value; }
	// int16 getMergeRoadHeight() { return _roadMergeHeight; }
	// void setMergeRoadHeight(int16 value) { _roadMergeHeight = value; }
	// uint16 getMergeRoadStreetlight() { return _roadMergeStreetlightType; }
	// void setMergeRoadStreetlight(uint16 value) { _roadMergeStreetlightType = value; }
	// int16 getAdditionSupportHeight() { return _trackRoadAdditionSupports.height; }
	...
	// const SupportHeight& getSupportHeight(uint8 segment) { return _supportSegments[segment]; }
	// const BridgeEntry& getBridgeEntry() { return _bridgeEntry; }
	// SegmentFlags get525CF8() { return _525CF8; }
	// int16 getWaterHeight() { return _waterHeight; }
	// int16 getWaterHeight2() { return _waterHeight2; }
	// int16 getSurfaceHeight() { return _surfaceHeight; }
	// uint8 getSurfaceSlope() { return _surfaceSlope; }
	...
	return WorldPos2{ _unkPositionX, _unkPositionY }
	// World::Pos2 getSpritePosition()
	return WorldPos2{ _spritePositionX, _spritePositionY }
	...
	// void setTrackModId(const uint8 mod) { _trackModId = mod; }
	...
	// void setUnkVpY(const uint16 y) { _unkVpPositionY = y; }
	// void setSegmentsSupportHeight(const SegmentFlags segments, const uint16 height, const uint8 slope);
	// void setSegmentSupportHeight(const uint8 segment, const uint16 height, const uint8 slope);
	// void setGeneralSupportHeight(const uint16 height, const uint8 slope);
	...
	// []<TunnelEntry> getTunnels(uint8 edge);
	// void insertTunnel(coord_t z, uint8 tunnelType, uint8 edge);
	// void insertTunnels(const []<int16, 4>& tunnelHeights, coord_t height, uint8 tunnelType);
	// void setDidPassSurface(bool value) { _didPassSurface = value; }
	// void setSurfaceSlope(uint8 slope) { _surfaceSlope = slope; }
	// void setSurfaceHeight(int16 height) { _surfaceHeight = height; }
	// void setWaterHeight(int16 height) { _waterHeight = height; }
	// void setWaterHeight2(int16 height) { _waterHeight2 = height; }
	...
	// */
	// PaintStringStruct* addToStringPlotList(const uint32 amount, const StringId stringId, const uint16 z, const int16 xOffset, const int8_t* yOffsets, const uint16 colour);
	// /*
	// * @param rotation @<ebp>
	// * @param imageId  @<ebx>
	// * @param offsetX @<al>
	...
	// * @param boundBoxOffsetZ @<0xE3F0A4>
	// */
	// PaintStruct* addToPlotListTrackRoad(ImageId imageId, uint32 priority, const World::Pos3& offset, const World::Pos3& boundBoxOffset, const World::Pos3& boundBoxSize);
	// /*
	// * @param rotation @<ebp>
	// * @param imageId  @<ebx>
	// * @param priority @<ecx>
	...
	// * @param boundBoxOffsetZ @<0xE3F0A4>
	// */
	// PaintStruct* addToPlotListTrackRoadAddition(ImageId imageId, uint32 priority, const World::Pos3& offset, const World::Pos3& boundBoxOffset, const World::Pos3& boundBoxSize);
	// /*
	// * @param rotation @<ebp>
	// * @param imageId  @<ebx>
	// * @param offsetX @<al>
	...
	// void finaliseOrdering([]<PaintStruct*> paintStructs);
	// union PaintEntry
	basic PaintStruct
	attached AttachedPaintStruct
	string PaintStringStruct
	// PaintEntry() {}
	// };
	...
	// int16 _vpPositionY{};
	// int16 _unkVpPositionY{};
	// bool _didPassSurface{};
	// World::Pos3 _boundingBoxOffset{};
	// int16 _foregroundCullingHeight{};
	// Ui::ViewportInteraction::InteractionItem _itemType{};
	// uint8 _trackModId{};
	// World::Pos2 _mapPosition{};
	// void* _currentItem{};
	// uint8 currentRotation{}; // new field set from 0x00E3F0B8 but split out into this struct as separate item
	// Ui::ViewportFlags _viewFlags{};
	// []<PaintStruct*, kMaxPaintQuadrants> _quadrants;
	var _quadrantBackIndex uint32
	var _quadrantFrontIndex uint32
	// []<PaintStruct*, 5> _trackRoadPaintStructs;
	// []<PaintStruct*, 2> _trackRoadAdditionsPaintStructs;
	// int32 _E400EC{};
	// int16 _E400F0{};
	// int16 _E400F2{};
	// int32 _E400F4{};
	...
	// []<uint8, 4> _tunnelCounts{};
	// []<TunnelEntry, 33> _tunnels0{}; // There are only 32 entries but 33 and -1 are also writeable for marking the end/start
	// []<TunnelEntry, 33> _tunnels1{}; // There are only 32 entries but 33 and -1 are also writeable for marking the end/start
	// []<TunnelEntry, 33> _tunnels2{}; // There are only 32 entries but 33 and -1 are also writeable for marking the end/start
	// []<TunnelEntry, 33> _tunnels3{}; // There are only 32 entries but 33 and -1 are also writeable for marking the end/start
	...
	// int16 _waterHeight2{};
	// uint8 _surfaceSlope{};
	// int16 _surfaceHeight{};
	// uint32 _roadMergeBaseImage{};
	// uint32 _roadMergeExits{};
	// int16 _roadMergeHeight{};
	// uint16 _roadMergeStreetlightType{};
...
// SKIPPED CONSTRUCTOR: 	static_assert(std.same_as<T, PaintStruct> || std.same_as<T, AttachedPaintStruct> || std.same_as<T, PaintStringStruct>)
