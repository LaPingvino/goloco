...
// consteval RoadPaintCommonPiece rotateRoadPCP(const RoadPaintCommonPiece& reference, const []<uint8, 4>& rotationTable)
...
StraightRPCP = [1]RoadPaintCommonPiece{
// kStraight0,
...
RightCurveVerySmallRPCP = [1]RoadPaintCommonPiece{
// kRightCurveVerySmall0,
// SKIPPED CONSTRUCTOR: const LeftCurveVerySmall0 RoadPaintCommonPiece = rotateRoadPCP(kRightCurveVerySmall0, kRotationTable1230)
LeftCurveVerySmallRPCP = [1]RoadPaintCommonPiece{
...
RightCurveSmallRPCP = [4]RoadPaintCommonPiece{
// kRightCurveSmall0,
// kRightCurveSmall1,
// kRightCurveSmall2,
// kRightCurveSmall3,
// SKIPPED CONSTRUCTOR: const LeftCurveSmall0 RoadPaintCommonPiece = rotateRoadPCP(kRightCurveSmall3, kRotationTable1230)
// SKIPPED CONSTRUCTOR: const LeftCurveSmall1 RoadPaintCommonPiece = rotateRoadPCP(kRightCurveSmall1, kRotationTable1230)
// SKIPPED CONSTRUCTOR: const LeftCurveSmall2 RoadPaintCommonPiece = rotateRoadPCP(kRightCurveSmall2, kRotationTable1230)
// SKIPPED CONSTRUCTOR: const LeftCurveSmall3 RoadPaintCommonPiece = rotateRoadPCP(kRightCurveSmall0, kRotationTable1230)
LeftCurveSmallRPCP = [4]RoadPaintCommonPiece{
// kLeftCurveSmall0,
// kLeftCurveSmall1,
// kLeftCurveSmall2,
// kLeftCurveSmall3,
...
// },
// /* Segments */ SegmentFlags::x0y0 | SegmentFlags::x2y0 | SegmentFlags::x0y2 | SegmentFlags::x2y2 | SegmentFlags::x1y1 | SegmentFlags::x0y1 | SegmentFlags::x2y1,
StraightSlopeUpRPCP = [2]RoadPaintCommonPiece{
// kStraightSlopeUp0,
// kStraightSlopeUp1,
// SKIPPED CONSTRUCTOR: const StraightSlopeDown0 RoadPaintCommonPiece = rotateRoadPCP(kStraightSlopeUp1, kRotationTable2301)
// SKIPPED CONSTRUCTOR: const StraightSlopeDown1 RoadPaintCommonPiece = rotateRoadPCP(kStraightSlopeUp0, kRotationTable2301)
StraightSlopeDownRPCP = [2]RoadPaintCommonPiece{
// kStraightSlopeDown0,
// kStraightSlopeDown1,
...
// },
// /* Segments */ SegmentFlags::x0y0 | SegmentFlags::x2y0 | SegmentFlags::x0y2 | SegmentFlags::x2y2 | SegmentFlags::x1y1 | SegmentFlags::x0y1 | SegmentFlags::x2y1,
StraightSteepSlopeUpRPCP = [1]RoadPaintCommonPiece{
// kStraightSteepSlopeUp0,
// SKIPPED CONSTRUCTOR: const StraightSteepSlopeDown0 RoadPaintCommonPiece = rotateRoadPCP(kStraightSteepSlopeUp0, kRotationTable2301)
StraightSteepSlopeDownRPCP = [1]RoadPaintCommonPiece{
...
TurnaroundRPCP = [1]RoadPaintCommonPiece{
// kTurnaround0,
// constexpr []<[]<const RoadPaintCommonPiece>, 10> kRoadPaintCommonParts = {
// kStraightRPCP,
...
// const []<int16, 4>& _streetlightHeights,
// const []<RoadPaintMergeType, 4> _isMultiTileMerge)
...
// constexpr RoadPaintMergeablePiece(
// const []<uint32, 4>& _imageIndexOffsets,
// const []<[]<int16, 4>, 4>& _streetlightHeights,
// const []<RoadPaintMergeType, 4> _isMultiTileMerge)
// : imageIndexOffsets(_imageIndexOffsets)
// , streetlightHeights(_streetlightHeights)
// , isMultiTileMerge(_isMultiTileMerge)
// []<uint32, 4> imageIndexOffsets;
// []<[]<int16, 4>, 4> streetlightHeights;
// []<RoadPaintMergeType, 4> isMultiTileMerge;
const NoStreetlight int16 = -1
NoRoadPaintMerge = [4]RoadPaintMergeType{
// RoadPaintMergeType::none,
// RoadPaintMergeType::none,
// RoadPaintMergeType::none,
// RoadPaintMergeType::none,
NoStreetlights = [4]int16{
// consteval RoadPaintMergeablePiece rotateRoadPP(const RoadPaintMergeablePiece& reference, const []<uint8, 4>& rotationTable)
