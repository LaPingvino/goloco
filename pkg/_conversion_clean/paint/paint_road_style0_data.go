...
// /* IsMultiTileMerge */ []<RoadPaintMergeType, 4>{ RoadPaintMergeType::standard, RoadPaintMergeType::standard, RoadPaintMergeType::standard, RoadPaintMergeType::standard },
...
// SKIPPED CONSTRUCTOR: const LeftCurveVerySmall0 RoadPaintMergeablePiece = rotateRoadPP(kRightCurveVerySmall0, kRotationTable1230)
...
// kRightCurveSmall2,
// kRightCurveSmall3,
// SKIPPED CONSTRUCTOR: const LeftCurveSmall0 RoadPaintMergeablePiece = rotateRoadPP(kRightCurveSmall3, kRotationTable1230)
// SKIPPED CONSTRUCTOR: const LeftCurveSmall1 RoadPaintMergeablePiece = rotateRoadPP(kRightCurveSmall1, kRotationTable1230)
// SKIPPED CONSTRUCTOR: const LeftCurveSmall2 RoadPaintMergeablePiece = rotateRoadPP(kRightCurveSmall2, kRotationTable1230)
// SKIPPED CONSTRUCTOR: const LeftCurveSmall3 RoadPaintMergeablePiece = rotateRoadPP(kRightCurveSmall0, kRotationTable1230)
...
// kStraightSlopeUp0,
// kStraightSlopeUp1,
// SKIPPED CONSTRUCTOR: const StraightSlopeDown0 RoadPaintMergeablePiece = rotateRoadPP(kStraightSlopeUp1, kRotationTable2301)
// SKIPPED CONSTRUCTOR: const StraightSlopeDown1 RoadPaintMergeablePiece = rotateRoadPP(kStraightSlopeUp0, kRotationTable2301)
...
// SKIPPED CONSTRUCTOR: const StraightSteepSlopeDown0 RoadPaintMergeablePiece = rotateRoadPP(kStraightSteepSlopeUp0, kRotationTable2301)
...
// kTurnaround0,
// constexpr []<[]<const RoadPaintMergeablePiece>, 10> kRoadPaintParts = {
// kStraightTPP,
