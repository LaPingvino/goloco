...
// SKIPPED CONSTRUCTOR: const LeftCurveVerySmallAddition0 RoadPaintAdditionPiece = rotateRoadPPA(kRightCurveVerySmallAddition0, kRotationTable1230)
func init() {
...
// SKIPPED CONSTRUCTOR: const LeftCurveSmallAddition0 RoadPaintAdditionPiece = rotateRoadPPA(kRightCurveSmallAddition3, kRotationTable1230)
...
// SKIPPED CONSTRUCTOR: const LeftCurveSmallAddition3 RoadPaintAdditionPiece = rotateRoadPPA(kRightCurveSmallAddition0, kRotationTable1230)
func init() {
...
// SKIPPED CONSTRUCTOR: const StraightSlopeDownAddition0 RoadPaintAdditionPiece = rotateRoadPPA(kStraightSlopeUpAddition1, kRotationTable2301)
// SKIPPED CONSTRUCTOR: const StraightSlopeDownAddition1 RoadPaintAdditionPiece = rotateRoadPPA(kStraightSlopeUpAddition0, kRotationTable2301)
func init() {
...
// SKIPPED CONSTRUCTOR: const StraightSteepSlopeDownAddition0 RoadPaintAdditionPiece = rotateRoadPPA(kStraightSteepSlopeUpAddition0, kRotationTable2301)
func init() {
