...
// SKIPPED CONSTRUCTOR: 	Unk_m00 UpdateVar1136114Flags = (1 << 0)
// SKIPPED CONSTRUCTOR: 	NoRouteFound UpdateVar1136114Flags = (1 << 1)
// SKIPPED CONSTRUCTOR: 	Crashed UpdateVar1136114Flags = (1 << 2)
// SKIPPED CONSTRUCTOR: 	Unk_m03 UpdateVar1136114Flags = (1 << 3)
// SKIPPED CONSTRUCTOR: 	ApproachingGradeCrossing UpdateVar1136114Flags = (1 << 4)
// SKIPPED CONSTRUCTOR: 	Unk_m15 UpdateVar1136114Flags = (1 << 15)
...
type TrackAndDirectionTrackAndDirection struct {
	Data uint16
	// method: constexpr _TrackAndDirection(uint8 id, uint8 direction)
// : _data((id << 3) | direction)
func (t *TrackAndDirection) Id() uint8 {
	// constexpr uint8 cardinalDirection() const { return _data & 0x3; }
...
type TrackAndDirectionRoadAndDirection struct {
	// method: constexpr _RoadAndDirection(uint8 id, uint8 direction)
// : _data((id << 3) | direction)
func (t *TrackAndDirection) Id() uint8 {
	// constexpr uint8 cardinalDirection() const { return _data & 0x3; }
	...
	// _data &= ~(1 << 2);
	// _data |= state ? (1 << 2) : 0;
	// constexpr uint8 basicRad() const { return _data & 0x7F; }
...
// 0x3689,
// // 0x00500244
// constexpr []<World::TilePos2, 9> kMooreNeighbourhood = {
// World::TilePos2{ 0, 0 },
// World::TilePos2{ 0, 1 },
// World::TilePos2{ 1, 1 },
// World::TilePos2{ 1, 0 },
...
func GetSubType() VehicleEntityType {
	...
	// int32 getRemainingDistance() const;
	...
	// void destroyTrain();
	// uint8 updateRoadTileOccupancy(const World::Pos3& loc, const TrackAndDirection::_RoadAndDirection rad, const bool setOccupied);
	// UpdateMotionResult updateTrackMotion(int32 unk1, bool isVeh2UnkM15);
...
// uint16 targetZ = 0U;                    // 0x01136168
// uint32 manhattanDistanceToStation = 0U; // 0x011360D0
// uint8 targetYaw = 0U;                   // 0x0113646D
