...
type VehicleBody struct {
	...
	// method: void secondaryAnimationUpdate(const Vehicle& train, const CarUpdateState& carState, const int32 unkDistance);
	// method: void updateSegmentCrashed(const CarUpdateState& carState);
	// method: void sub_4AAB0B(const CarUpdateState& carState, const int32 unkDistance);
...
// MALFORMED FIELD: const VehicleBodyVehicleThingType any = VehicleEntityType.body_continued
