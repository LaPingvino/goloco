...
// template<DrawBlendOp TBlendOp, uint8 TZoomLevel>
...
// const int32 width = args.size.width;
// int32 height = args.size.height;
...
// for (int32 widthRemaining = width; widthRemaining > 0; widthRemaining -= zoom, src += zoom, noiseMask += zoom, dst++)
...
// auto* nextSrc = src + srcLineWidth;
// auto* nextDst = dst + dstLineWidth;
// for (int32 widthRemaining = width; widthRemaining > 0; widthRemaining -= zoom, src += zoom, dst++)
