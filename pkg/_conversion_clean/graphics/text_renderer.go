...
// SKIPPED CONSTRUCTOR: 	Inset     TextDrawFlags = (1 << 0)
// SKIPPED CONSTRUCTOR: 	Outline   TextDrawFlags = (1 << 1)
// SKIPPED CONSTRUCTOR: 	Dark      TextDrawFlags = (1 << 2)
// SKIPPED CONSTRUCTOR: 	ExtraDark TextDrawFlags = (1 << 3)
}
