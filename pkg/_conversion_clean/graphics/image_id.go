...
// uint32 _index = kImageIndexUndefined;
// [[nodiscard]] static ImageId fromUInt32(uint32 value)
	Result ImageId
// result._index = value;
	Result return
}
// MALFORMED FIELD: const ImageIdIndexUndefined uint32 = 0b00000000000001111111111111111111
// MALFORMED FIELD: const ImageIdMaskIndex uint32 = 0b00000000000001111111111111111111
// MALFORMED FIELD: const ImageIdMaskRemap uint32 = 0b00000011111110000000000000000000
// MALFORMED FIELD: const ImageIdMaskTranslucent uint32 = 0b00000111111110000000000000000000
// MALFORMED FIELD: const ImageIdMaskPrimary uint32 = 0b00000000111110000000000000000000
// MALFORMED FIELD: const ImageIdMaskSecondary uint32 = 0b00011111000000000000000000000000
// MALFORMED FIELD: const ImageIdMaskNoiseMask uint32 = 0b00011100000000000000000000000000
// MALFORMED FIELD: const ImageIdFlagPrimary uint32 = 0b00100000000000000000000000000000
// MALFORMED FIELD: const ImageIdFlagBlend uint32 = 0b01000000000000000000000000000000
// MALFORMED FIELD: const ImageIdFlagSecondary uint32 = 0b10000000000000000000000000000000
// MALFORMED FIELD: const ImageIdShiftRemap uint32 = 19
// MALFORMED FIELD: const ImageIdShiftPrimary uint32 = 19
// MALFORMED FIELD: const ImageIdShiftTranslucent uint32 = 19
// MALFORMED FIELD: const ImageIdShiftSecondary uint32 = 24
// MALFORMED FIELD: const ImageIdShiftNoiseMask uint32 = 26
// MALFORMED FIELD: const ImageIdValueUndefined uint32 = kIndexUndefined
// MALFORMED FIELD: const ImageIdImageIndexUndefined ImageIndex = std.numeric_limits<ImageIndex>.max()
// ImageId() = default;
...
// [[nodiscard]] constexpr uint8 getNoiseMask() const
...
// [[nodiscard]] constexpr ImageId withIndexOffset(int32 offset) const
// ImageId result = *this;
...
// [[nodiscard]] constexpr ImageId withNoiseMask(uint8 noise) const
// ImageId result = *this;
