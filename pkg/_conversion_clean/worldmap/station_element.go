...
// SKIPPED CONSTRUCTOR: 	e.data[0] = (e.data[0] & 0xE0) | (id & 0x1F)
...
// SKIPPED CONSTRUCTOR: 	e.data[0] = (e.data[0] & 0x1F) | ((stationType & 0x07) << 5)

// StationId returns the station ID
func (e *StationElement) StationId() uint16 {
// SKIPPED CONSTRUCTOR: 	return uint16(e.data[1]) | (uint16(e.data[2]&0x03) << 8)

// SetStationId sets the station ID
func (e *StationElement) SetStationId(id uint16) {
// SKIPPED CONSTRUCTOR: 	e.data[1] = uint8(id)
// SKIPPED CONSTRUCTOR: 	e.data[2] = (e.data[2] & 0xFC) | uint8((id>>8)&0x03)

// Owner returns the owning company ID
func (e *StationElement) Owner() CompanyId {
// SKIPPED CONSTRUCTOR: 	return CompanyId((e.data[2] >> 4) & 0x0F)

// SetOwner sets the owning company ID
func (e *StationElement) SetOwner(owner CompanyId) {
// SKIPPED CONSTRUCTOR: 	e.data[2] = (e.data[2] & 0x0F) | ((uint8(owner) & 0x0F) << 4)
...
// SKIPPED CONSTRUCTOR: 	e.data[3] = (e.data[3] & 0xFC) | (index & 0x03)