...
// SKIPPED CONSTRUCTOR: 	e.data[0] = (e.data[0] & 0xF0) | (id & 0x0F)
...
// SKIPPED CONSTRUCTOR: 	e.data[1] = (e.data[1] & 0x0F) | ((id & 0x0F) << 4)

// Owner returns the owning company ID
func (e *RoadElement) Owner() CompanyId {
// SKIPPED CONSTRUCTOR: 	return CompanyId(e.data[2] & 0x0F)

// SetOwner sets the owning company ID
func (e *RoadElement) SetOwner(owner CompanyId) {
// SKIPPED CONSTRUCTOR: 	e.data[2] = (e.data[2] & 0xF0) | (uint8(owner) & 0x0F)
...
// SKIPPED CONSTRUCTOR: 	e.data[2] = (e.data[2] & 0x1F) | ((id & 0x07) << 5)
...
// SKIPPED CONSTRUCTOR: 	e.data[3] = (e.data[3] & 0xF0) | (id & 0x0F)
...
// SKIPPED CONSTRUCTOR: 	e.data[3] = (e.data[3] & 0x8F) | ((mods & 0x07) << 4)