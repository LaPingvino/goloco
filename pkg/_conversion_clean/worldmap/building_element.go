...
// SKIPPED CONSTRUCTOR: 	e.typ = (e.typ & 0xFC) | (rotation & 0x03)
...
// SKIPPED CONSTRUCTOR: 	e.data[1] = (e.data[1] & 0xFC) | (index & 0x03)
...
// SKIPPED CONSTRUCTOR: 	val := uint16(e.data[2]) | (uint16(e.data[3]) << 8)
// SKIPPED CONSTRUCTOR: 	val = (val & 0xFFC0) | uint16(age&0x3F)
// SKIPPED CONSTRUCTOR: 	e.data[2] = uint8(val)
// SKIPPED CONSTRUCTOR: 	e.data[3] = uint8(val >> 8)

// Variation returns the building variation
func (e *BuildingElement) Variation() uint8 {
// SKIPPED CONSTRUCTOR: 	return uint8((val >> 6) & 0x1F)

// SetVariation sets the building variation
func (e *BuildingElement) SetVariation(variation uint8) {
// SKIPPED CONSTRUCTOR: 	val = (val & 0xF83F) | (uint16(variation&0x1F) << 6)

// Colour returns the building colour
func (e *BuildingElement) Colour() uint8 {
// SKIPPED CONSTRUCTOR: 	return uint8((uint16(e.data[2]) | (uint16(e.data[3]) << 8)) >> 11)

// SetColour sets the building colour
func (e *BuildingElement) SetColour(colour uint8) {
// SKIPPED CONSTRUCTOR: 	val = (val & 0x07FF) | (uint16(colour) << 11)