...
// SKIPPED CONSTRUCTOR: 	e.data[0] = (e.data[0] & 0xE0) | (slope & 0x1F)
...
// SKIPPED CONSTRUCTOR: 	e.data[0] = (e.data[0] & 0x1F) | (coverage << 5)
...
// SKIPPED CONSTRUCTOR: 	e.data[1] = (e.data[1] & 0xE0) | (level & 0x1F)
...
// SKIPPED CONSTRUCTOR: 	e.data[2] = (e.data[2] & 0xE0) | (terrain & 0x1F)
...
// SKIPPED CONSTRUCTOR: 	e.data[2] = (e.data[2] & 0x1F) | (stage << 5)
...
// SKIPPED CONSTRUCTOR: 	return IndustryId(e.data[3])

// SetIndustry sets the industry ID
func (e *SurfaceElement) SetIndustry(id IndustryId) {
// SKIPPED CONSTRUCTOR: 	e.data[3] = uint8(id)
...
func NewSurfaceElement(baseZ, clearZ SmallZ, terrain uint8) *SurfaceElement {
	elem := &SurfaceElement{}
// SKIPPED CONSTRUCTOR: 	elem.SetType(ElementTypeSurface)
// SKIPPED CONSTRUCTOR: 	elem.SetBaseZ(baseZ)
// SKIPPED CONSTRUCTOR: 	elem.SetClearZ(clearZ)
// SKIPPED CONSTRUCTOR: 	elem.SetTerrain(terrain)
	return elem