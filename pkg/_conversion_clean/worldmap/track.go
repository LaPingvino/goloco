...
// SKIPPED CONSTRUCTOR: const IsOvertaking uint16 = (1 << 7)
// SKIPPED CONSTRUCTOR: const IsChangingLane uint16 = (1 << 8)
// SKIPPED CONSTRUCTOR: const HasBridge uint16 = (1 << 12)
// SKIPPED CONSTRUCTOR: const HasMods uint16 = (1 << 13)
// SKIPPED CONSTRUCTOR: const HasSignal uint16 = (1 << 15)
...
// sfl::static_vector<uint16, 16> connections;
// StationId stationId = StationId::null; // 0x01135FAE
// uint8 stationObjectId = 0U;          // 0x01136087
// uint8 roadObjectId = 0xFFU;          // 0x0112C2ED (I wouldn't trust this to be correct which connection!)
}
