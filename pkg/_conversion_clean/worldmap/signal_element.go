...
// SKIPPED CONSTRUCTOR: 	e.data[0] = (e.data[0] & 0x0F) | ((id & 0x0F) << 4)
...
// SKIPPED CONSTRUCTOR: 	e.data[2] = (e.data[2] & 0xFC) | (state & 0x03)
...
// SKIPPED CONSTRUCTOR: 	e.data[2] = (e.data[2] & 0xF3) | ((state & 0x03) << 2)