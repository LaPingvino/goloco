...
// SKIPPED C++ SYNTAX: type Iterator_concept = std::forward_iterator_tag
...
// public:
// SKIPPED CONSTRUCTOR: const Npos int = std.numeric_limits<size_t>().max()
// const TilePos2 pos;
...
// StationElement* trainStation(uint8 trackId, uint8 direction, uint8 baseZ) const;
// StationElement* roadStation(uint8 roadId, uint8 direction, uint8 baseZ) const;