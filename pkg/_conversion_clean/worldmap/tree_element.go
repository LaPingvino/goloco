...
// SKIPPED CONSTRUCTOR: 	e.data[0] = (e.data[0] & 0xC0) | (id & 0x3F)

// Colour returns the tree colour
func (e *TreeElement) Colour() uint8 {
// SKIPPED CONSTRUCTOR: 	return ((e.data[0] >> 6) & 0x03) | ((e.data[1] & 0x03) << 2)

// SetColour sets the tree colour
func (e *TreeElement) SetColour(colour uint8) {
// SKIPPED CONSTRUCTOR: 	e.data[0] = (e.data[0] & 0x3F) | ((colour & 0x03) << 6)
// SKIPPED CONSTRUCTOR: 	e.data[1] = (e.data[1] & 0xFC) | ((colour >> 2) & 0x03)
...
// SKIPPED CONSTRUCTOR: 	e.data[1] = (e.data[1] & 0x3F) | ((season & 0x03) << 6)
...
// SKIPPED CONSTRUCTOR: 	e.data[2] = (e.data[2] & 0xE7) | ((snow & 0x03) << 3)
