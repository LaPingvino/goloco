...
// MALFORMED FIELD: const ChangeCompanyColourSchemeArgsCommand any = GameCommand.changeCompanyColourScheme

// orphan member: CompanyId companyId;
// orphan member: bool isPrimary;
// orphan member: uint8 value;
// orphan member: uint8 colourType;
