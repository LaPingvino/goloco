...
// MALFORMED FIELD: const VehicleApplyShuntCheatArgsCommand any = GameCommand.vehicleApplyShuntCheat
...
// orphan member: int32 param1{};
// orphan member: int32 param2{};
// orphan member: int32 param3{};
// explicit operator registers() const
// orphan member: registers regs;
