...
// SKIPPED CONSTRUCTOR: 	BodyColour         VehicleRepaintFlags = (1 << 0)
// SKIPPED CONSTRUCTOR: 	FrontBogieColour   VehicleRepaintFlags = (1 << 1)
// SKIPPED CONSTRUCTOR: 	BackBogieColour    VehicleRepaintFlags = (1 << 2)
// SKIPPED CONSTRUCTOR: 	ApplyToEntireCar   VehicleRepaintFlags = (1 << 3)
// SKIPPED CONSTRUCTOR: 	ApplyToEntireTrain VehicleRepaintFlags = (1 << 4)
