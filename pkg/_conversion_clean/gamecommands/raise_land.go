...
type RaiseLandArgs struct {
	// RaiseLandArgs() = default;
	// method: explicit RaiseLandArgs(const registers& regs)
...
// MALFORMED FIELD: const RaiseLandArgsCommand any = GameCommand.raiseLand
...
// func RaiseLand(args RaiseLandArgs, removedBuildings World::TileClearance::RemovedBuildings, flags uint8) uint32
// func RaiseLand(regs registers)
