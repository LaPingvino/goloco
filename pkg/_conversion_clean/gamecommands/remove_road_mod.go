...
type RoadModsRemovalArgs struct {
	// RoadModsRemovalArgs() = default;
	// method: explicit RoadModsRemovalArgs(const registers& regs)
...
// MALFORMED FIELD: const RoadModsRemovalArgsCommand any = GameCommand.removeRoadMod
...
// orphan member: uint8 roadObjType;
...
// func RemoveRoadMod(regs registers)