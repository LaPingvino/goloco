...
// MALFORMED FIELD: const VehiclePlacementArgsCommand any = GameCommand.vehiclePlace

// World::Pos3 pos;
// orphan member: uint16 trackAndDirection;
// orphan member: uint16 trackProgress;
