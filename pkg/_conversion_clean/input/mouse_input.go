...
// static int32 _pressedWidgetIndex;             // 0x00523372
// static uint16 _clickRepeatTicks;              // 0x00523376
...
// static uint8 _dragWidgetIndex;                // 0x0052337F
// static uint8 _dragScrollIndex;                // 0x00523380
// static uint16 _ticksSinceDragStart; // 0x0052338E
// static Ui::Point _scrollLast;           // 0x005233A4
// static Ui::WindowType _hoverWindowType; // 0x005233A8
// static uint8 _5233A9;
// static Ui::WindowNumber_t _hoverWindowNumber; // 0x005233AA
// static Ui::WidgetIndex_t _hoverWidgetIdx;     // 0x005233AC
// static int32 _mouseDeltaX; // 0x0114084C
// static int32 _mouseDeltaY; // 0x01140840
// static int32 _mousePosX;   // 0x005233AE
// static int32 _mousePosY;   // 0x005233B2
...
// window->callScrollMouseOver(res.scrollviewLoc.x, res.scrollviewLoc.y, static_cast<uint8>(res.index));
// else
...
// if (window != nullptr)
// int16 widgetIdx = window->findWidgetAt(x, y);
// if (widgetIdx != -1)
...
// return static_cast<uint32>(std::pow(10, getClickRepeatTicks() / 100));
